...
export async function run(source: string, config: Config, optimizationSwitch: "0" | "1" | "2" | "3"): Promise<[Value<Annotation>, GlobalEnv, GlobalTypeEnv, string, WebAssembly.WebAssemblyInstantiatedSource]> {
