...
describe("Project test cases", () => {
    ...
    test_uniop("9_test_negate", BigInt("100000000000000000000000"), "-", "-100000000000000000000000");
    test_param_return("10_test_param_return", BigInt("100000000000000000000000"), BigInt(0), "100000000000000000000000");
});