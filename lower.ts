...
import { APPLY, CLASS, createMethodName, BOOL, NONE, NUM, makeWasmFunType } from './utils';
              ...
              s.destruct.vars.forEach(v => {
                ...
                switch(v.target.tag) {
                  ...
                  case "lookup":
                    ...
                    const offset : IR.Value<Annotation> = { tag: "wasmint", value: classdata[0].get(v.target.field)[0] };
